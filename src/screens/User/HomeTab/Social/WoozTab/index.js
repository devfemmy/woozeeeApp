...
//   const WoozPostsAreaTwo = () => {
//     const isFocused = useIsFocused();

//     const [index, setIndex] = useState(0);

//     // const [fgdgfg, setForceUpdate] = useState(null);
...
//       async ({ pageParam = 1 }) => {
//         const currentPage = Math.floor(finalVideoRef.current.length / 10);
//         // const promise = await Api.getWoozVideos(Math.floor(currentPage + 1));
...
//     ) {
//       videoLength.current = finalVideoRef.current.length;

//       const res = data.pages.map((page) => page.pageData.data);
//       let final = res.reduce((acc, element) => {
//         return [...acc, ...element];
//       }, []);
...
//         // console.log('new index', final[newIndex]);
//         // setIndex(newIndex);
...
//           console.log(error);
//         }
//         // if (finalVideoRef.current.length - newIndex <= 5 && newIndex > index) {
//         //   // fetchNextPage();
//         // }
//         if (
//           // prettier-ignore
...
//       // console.log(finalVideoRef.current[index].mediaURL);
...
//                 resizeMode="contain"
//                 style={[StyleSheet.absoluteFillObject, { flex: 1 }]}
//                 source={{ uri: data.page.pageData.data[index].mediaURL }}
//                 isLooping
//                 onPlaybackStatusUpdate={(playbackStatus) => {
//                   positionRef.current =
...
//                   onPlaybackStatusUpdate(playbackStatus, final[index]._id);
//                 }}
//                 isMuted={false}
//                 shouldPlay={isFocused}
//                 // prettier-ignore

                        ...
                        <>
                            <TouchableOpacity style={{ flexDirection: 'row', marginBottom: 20, marginTop: 20 }} onPress={() => this.props.navigation.navigate('ChatScreen', { name: item.userName, guestUid: item.uuid })}>
                                ...
                                <View style={{ width: '65%', alignItems: 'flex-start', justifyContent: 'center', marginLeft: 10 }}>
                                    ...
                                    <Text style={{ color: 'rgba(0, 0, 0, 0.5)', fontSize: 14, fontWeight: '600' }}>{item.lastMessage}</Text>
                                </View>
                                <View style={{ width: '20%', alignItems: 'flex-start', justifyContent: 'center', marginRight: 20 }}>
                                    <Text style={{ color: 'rgba(0, 0, 0, 0.5)', fontSize: 13, fontWeight: '400' }}>{item.lastTime}</Text>
                                </View>
                            </TouchableOpacity>
